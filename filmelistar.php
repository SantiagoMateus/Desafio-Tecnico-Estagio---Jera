...
<?php
  ...
  $tmdb->setAPIKey('79b58f29c2a3251991fd7e008bfe9d61');
 ?>
 <!DOCTYPE html>
 <html>
   <head>
   ...
   <body>
     <form action="filme2.php" method="post">
       <fieldset>
         <legend>Insira um filme com seu respectivo ID para adicionar a watchlist!</legend>
				 <legend>Obs: você pode buscar um filme e logo ao lado estará o seu ID</legend>
         <label>
           <input type="text" name="filme2">
         </label>
     ...
     <br>
		 <br>
     <br>
		 <a href="pagina_inicial.php">BUSCAR FILME</a>
		 <br>
		 <br>
